...
const Img = (props) => (<div className="features-img" style={props.style}></div>);
const Feature = (props) => (
					...
					<div className="features-slider">
						<div className="features-slider_items">
							...
							<div className="features-slider_item">
								<Img style={background1}/>
								<Feature name="Первое"/>
							</div>
							<div className="features-slider_item">
								<Img style={background2}/>
								<Feature name="Второе"/>
							</div>
							<div className="features-slider_item">
								<Img style={background3}/>
								<Feature name="Третье"/>
							</div>
							<div className="features-slider_item">
								<Img style={background4}/>
								<Feature name="Четвертое"/>
							</div>
						</div>
